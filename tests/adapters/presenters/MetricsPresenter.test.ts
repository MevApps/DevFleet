...
import { ComputeFinancials } from "../../../src/use-cases/ComputeFinancials"
...
describe("MetricsPresenter", () => {
  ...
  beforeEach(async () => {
    ...
    presenter = new MetricsPresenter(taskRepo, new ComputeFinancials(eventStore))
  ...
  it("computes metrics summary", async () => {
    ...
    expect(dto.totalTokensUsed).toBe(1_500)
